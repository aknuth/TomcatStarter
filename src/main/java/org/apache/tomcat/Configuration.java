...
public final class Configuration {
	...
	void addWebApp(String contextPath, String webAppSourceDirectory, String jarsToSkip, String jarsToScan) {
		webApps.add(new WebAppConfiguration(contextPath, normalize(webAppSourceDirectory), jarsToSkip, jarsToScan));
	}
	...
	public String toString() {
		...
		if (webApps != null) {
			...
			for (WebAppConfiguration webAppConfiguration : webApps) {
